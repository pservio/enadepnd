  ...
  blocos: [
    {
      ...
      subtitulo: "Esta pesquisa é conduzida por " + PROF + " sobre o efeito das aulas de revisão para o ENADE. " +
        ...
        "parear esta resposta com a que você deu no questionário de antes da prova; em qualquer análise, " +
        "apresentação ou publicação dos resultados, você será identificado(a) por um pseudônimo (nome fictício), " +
        "nunca pelo seu nome verdadeiro. Seus dados serão tratados com confidencialidade e usados apenas para " +
        "fins de pesquisa acadêmica." + (CONTATO ? " Dúvidas podem ser enviadas para " + CONTATO + "." : ""),
      campos: [
